...
class ErrorProcessor:
    ...
    def publish_error_notification(self, topic_arn: str, error_details: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            subject = f"Pipeline Error - {error_details.get('source', 'Unknown')} - {error_details.get('environment', 'Unknown')}"
    ...
    def put_custom_metric(self, metric_name: str, value: float, unit: str = 'Count', 
                         namespace: str = 'DataPipeline/Errors', dimensions: Optional[Dict[str, str]] = None) -> bool:
...
def main(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        if error_topic_arn:
            notification_sent = error_processor.publish_error_notification(
                error_topic_arn, error_details
            )
        else:
