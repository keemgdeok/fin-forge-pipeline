"""Market data ingestion pipeline stack."""
...
class MarketDataIngestionStack(Stack):
    ...
    def _create_worker_function(self) -> lambda_.IFunction:
        ...
        function = PythonFunction(
            ...
            function_name=f"{self.env_name}-market-data-ingestion-worker",
    ...
    def _create_orchestrator_function(self) -> lambda_.IFunction:
        ...
        function = PythonFunction(
            ...
            function_name=f"{self.env_name}-market-data-orchestrator",
            runtime=lambda_.Runtime.PYTHON_3_12,
    ...
    def _create_ingestion_schedule(self) -> events.Rule:
        """Create scheduled trigger for market data ingestion."""
        rule = events.Rule(
            self,
            "CustomerIngestionSchedule",
            rule_name=f"{self.env_name}-market-ingestion-schedule",
